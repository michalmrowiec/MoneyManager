...
{
    public class GetAllPlannedBudgetsTests : ControllerTestBase
    {
        public GetAllPlannedBudgetsTests(WebApplicationFactory<Startup> factory) : base(factory)
        { }
        ...
        public static IEnumerable<object[]> Test_GetPlannedBudgets => new List<object[]>
        {
            new object[]
            {
                ...
                new List<PlannedBudgetDto>
                {
                    ...
                    new PlannedBudgetDto { Id = 2,  Amount = 3M,        CategoryId = 4,    PlanForMonth = new DateTime(2012, 06, 01),  UserId = 1 },
                    new PlannedBudgetDto { Id = 3,  Amount = 89.23M,    CategoryId = 2,    PlanForMonth = new DateTime(2021, 12, 01),  UserId = 1 },
        ...
        public async Task GetAllPlannedBudgets_ForValidData_ReturnsListOfPlannedBudgetsForGivenMonth
            (List<CreateCategoryCommand> createCategories, List<CreatePlannedBudgetCommand> createPlannedBudgets, List<PlannedBudgetDto> expectedResult)
        {
            ...
            var responseMessage = await _httpClient.GetAsync($"/api/plannedbudget/");
