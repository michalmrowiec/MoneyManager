...
namespace BlazorApp1.Client.UnitTests.Services
{
    public class SortArrayServiceTests
    {
        public static IEnumerable<object[]> RecordsYears => new List<object[]>
        {
            new object[]
            {
                ...
                {
                    new RecordItemDto { Name = "bTest", Amount = 100, Date = new DateTime(2020, 01, 01) },
                    new RecordItemDto { Name = "nTest", Amount = 210, Date = new DateTime(2021, 01, 01) },
                    new RecordItemDto { Name = "aTest", Amount = 19999, Date = new DateTime(2017, 11, 11) },
                    new RecordItemDto { Name = "uTest", Amount = -1230, Date = new DateTime(2019, 04, 22) }
                },
            ...
            new object[]
            {
                new List<RecordItemDto>
                {
                    new RecordItemDto { Name = "baTest", Amount = -1, Date = new DateTime(2015, 01, 01) },
                    new RecordItemDto { Name = "nbTest", Amount = 777777, Date = new DateTime(2021, 01, 01) },
                    new RecordItemDto { Name = "asTest", Amount = 0, Date = new DateTime(2017, 11, 11) },
                    new RecordItemDto { Name = "u1Test", Amount = -130, Date = new DateTime(2019, 04, 22) }
                },
        ...
        public static IEnumerable<object[]> RecordsMonths => new List<object[]>
        {
            new object[]
            {
                ...
                {
                    new RecordItemDto { Name = "bTest", Amount = 100, Date = new DateTime(2020, 01, 01) },
                    new RecordItemDto { Name = "nTest", Amount = 210, Date = new DateTime(2020, 01, 01) },
                    new RecordItemDto { Name = "aTest", Amount = 19999, Date = new DateTime(2020, 11, 11) },
                    new RecordItemDto { Name = "uTest", Amount = -1230, Date = new DateTime(2020, 04, 22) }
                },
                "2020",
            ...
            new object[]
            {
                new List<RecordItemDto>
                {
                    new RecordItemDto { Name = "baTest", Amount = -1, Date = new DateTime(2015, 12, 01) },
                    new RecordItemDto { Name = "nbTest", Amount = 777777, Date = new DateTime(2015, 08, 01) },
                    new RecordItemDto { Name = "asTest", Amount = 0, Date = new DateTime(2015, 10, 11) },
                    new RecordItemDto { Name = "u1Test", Amount = -130, Date = new DateTime(2015, 03, 22) }
                },
                "2015",
        ...
        public static IEnumerable<object[]> DataForSortBy => new List<object[]>
        {
            ...
            new object[]
            {
                ...
                new List<RecordItemDto>
                {
                    new RecordItemDto { Name = "mTest", Amount = -1, Date = new DateTime(2015, 12, 01) },
                    new RecordItemDto { Name = "reTest", Amount = 7777.07M, Date = new DateTime(2015, 08, 01) },
                    new RecordItemDto { Name = "34Test", Amount = 0, Date = new DateTime(2015, 10, 11) },
                    new RecordItemDto { Name = "yTest", Amount = -130.65M, Date = new DateTime(2015, 03, 22) }
                },
                new string[] { "", "", "", "" },
                new List<RecordItemDto>
                {
            ...
            new object[]
            {
                ...
                new List<RecordItemDto>
                {
                    ...
                    new RecordItemDto { Name = "34Test", Amount = -1, Date = new DateTime(2021, 11, 11) },
                    new RecordItemDto { Name = "34Test", Amount = 0, Date = new DateTime(2016, 08, 02) },
                    new RecordItemDto { Name = "34Test", Amount = 16, Date = new DateTime(2017, 04, 07) },
                    new RecordItemDto { Name = "34Test", Amount = -48.5M, Date = new DateTime(2020, 12, 08) },
                    new RecordItemDto { Name = "34Test", Amount = 45.76M, Date = new DateTime(2021, 02, 11) },
                    new RecordItemDto { Name = "34Test", Amount = 18888888M, Date = new DateTime(2020, 12, 09) },
                    new RecordItemDto { Name = "34Test", Amount = -99990096.7M, Date = new DateTime(2015, 09, 14) },
                    new RecordItemDto { Name = "34Test", Amount = 24555.91M, Date = new DateTime(2016, 11, 29) },
                    new RecordItemDto { Name = "34Test", Amount = 0.53M, Date = new DateTime(2019, 01, 23) }
                },
                new string[] { "", "", "", "" },
                new List<RecordItemDto>
                {
